...
class PreviewController extends AbstractController {
	...
	public function indexAction($previewWS = NULL) {
		...
		unset($queryParameters['tx_workspacepreview_web_workspacepreviewworkspacepreview']);
		...
		$wsSettingsUri = $uriBuilder->uriFor('singleIndex', array(), 'Visol\\Workspacepreview\\Controller\\PreviewController', 'workspacepreview', 'web_workspacepreviewworkspacepreview');
		$wsSettingsParams = '&tx_workspacepreview_web_workspacesworkspaces[controller]=Review';
...
');
		$resourcePath = ExtensionManagementUtility::extRelPath('workspacepreview') . 'Resources/Public/';
